...
function Build(src)
{
    ...
    let main = `
        ...
        <div id="section">
            <h2>Download</h2>
            <iframe frameborder="0" src="https://itch.io/embed/${src.itch}" width="600" height="167"></iframe>
        </div>`;
    ...
    let team = `
        <div id="column">
            ...
            ${src.team.map((item, i) => `
                <div class="team">
                    <p><b>${src.team[i].name}</b><br>
                    <a href="http://${src.team[i].social}">${src.team[i].social}</a><br>
